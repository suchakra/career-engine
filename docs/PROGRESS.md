...
| Phase 8 — Operational hardening | ⬜ not started | 8A redeploy (no code), 8B dashboard "Find jobs" CTA, 8C sweep endpoint wiring, 8D model-client isolation (design-first), 8E deployer-SA least-privilege, 8F HITL TTL/override dashboard. Groomed in [GROOMING.md §Phase 8](GROOMING.md). |
