...
class TestCareerEngineStateRoundTrip:
    ...
    def test_state_carries_contract_version_2120(self) -> None:
        """CareerEngineState must be stamped with CONTRACT_VERSION == "2.12.0"."""
        state = CareerEngineState()
        assert state.contract_version == CONTRACT_VERSION
        assert CONTRACT_VERSION == "2.12.0"
...
class TestContractVersion:
    ...
    def test_contract_version_is_2120(self) -> None:
        """CONTRACT_VERSION must be exactly "2.12.0" (Bullet.derived_from_story_id — CQ-6)."""
        assert CONTRACT_VERSION == "2.12.0"
