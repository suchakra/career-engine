...
class TestCareerEngineStateRoundTrip:
    ...
    def test_state_carries_contract_version_230(self) -> None:
        """CareerEngineState must be stamped with CONTRACT_VERSION == '2.3.0'."""
...
class TestContractVersion:
    ...
    def test_contract_version_is_230(self) -> None:
        """CONTRACT_VERSION must be exactly '2.3.0' (Phase 3 escalation-gate bump)."""
        assert CONTRACT_VERSION == "2.3.0"
